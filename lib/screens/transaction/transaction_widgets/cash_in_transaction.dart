...
class CashInTransaction extends StatefulWidget {
  const CashInTransaction({Key? key}) : super(key: key);

  @override
  State<CashInTransaction> createState() => _CashInTransactionState();
}

class _CashInTransactionState extends State<CashInTransaction> {
  ...
  void initState() {
    context.read<TransactionBloc>().add(
          GetTransaction(
            context: context,
            txnType: AppConstants.txnCashIn,
          ),
        );
    super.initState();
  }
