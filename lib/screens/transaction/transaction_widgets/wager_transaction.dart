...
class WagerTransaction extends StatefulWidget {
  const WagerTransaction({Key? key}) : super(key: key);

  @override
  State<WagerTransaction> createState() => _WagerTransactionState();
}

class _WagerTransactionState extends State<WagerTransaction> {
