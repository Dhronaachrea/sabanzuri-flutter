...
class WinningTransaction extends StatefulWidget {
  const WinningTransaction({Key? key}) : super(key: key);

  @override
  State<WinningTransaction> createState() => _WinningTransactionState();
}

class _WinningTransactionState extends State<WinningTransaction> {
  ...
  void initState() {
    context.read<TransactionBloc>().add(
          GetTransaction(
            context: context,
            txnType: AppConstants.txnWinning,
          ),
        );
    super.initState();
  }
