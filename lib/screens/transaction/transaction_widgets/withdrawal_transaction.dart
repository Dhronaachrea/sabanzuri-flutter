...
class WithdrawalTransaction extends StatefulWidget {
  const WithdrawalTransaction({Key? key}) : super(key: key);

  @override
  State<WithdrawalTransaction> createState() => _WithdrawalTransactionState();
}

class _WithdrawalTransactionState extends State<WithdrawalTransaction> {
  ...
  void initState() {
    context.read<TransactionBloc>().add(
          GetTransaction(
            context: context,
            txnType: AppConstants.txnWithdrawal,
          ),
        );
    super.initState();
  }
